      ...
      <div className="Page">
        ...
        <section>
          ...
          <p>
            ...
            reading the Wiki or guide pages was not the easiest thing to do on a
            phone. And also, because I was bored.
            <br />
        ...
        <section>
          ...
          <p>
            ...
            can choose to see all the items (and their quantities) to make them
            all in one go.
            <br />
